...
VALUES ("Workingman's Dead by Grateful Dead - Vinyl", "Music", 19.99, 40, 1100), ("The Departed", "Movies", 19.99, 35, 2350), 
			 ("Asus Laptop", "Electronics", 949.99, 4, 3500), ("Super Slinky XL", "Toys", 9.99, 100, 1480), 
       ...
       ("Xbox One", "Electronics", 499.99, 25, 8000), ("Stop Making Sense by Talking Heads - Vinyl", "Music", 19.99, 17, 1100);
